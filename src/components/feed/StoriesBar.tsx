      ...
      <div className="flex gap-3 overflow-x-auto scrollbar-hide pb-1">
        ...
        >
          <div className="relative">
            <div className="w-12 h-12 rounded-full bg-accent overflow-hidden border border-border">
        ...
        {otherStories.map((story, i) => (
          ...
          >
            <div className="w-12 h-12 rounded-full p-[1.5px] bg-gradient-to-br from-primary to-primary/40">
