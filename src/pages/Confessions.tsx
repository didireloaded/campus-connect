...
export default function Confessions() {
  ...
  return (
    <div className="min-h-screen bg-background max-w-lg mx-auto">
      {/* Muted, anonymous-feeling header */}
      ...
      {/* Compose area - minimal, text-focused */}
      ...
      {/* Confessions feed - text-first, no avatars, minimal */}
        ...
        {confessions.map((c, i) => (
          ...
          >
            ...
            <div className="flex items-center justify-between mt-3 pt-2.5 border-t border-border/50">
              ...
              <button className="flex items-center gap-1 text-muted-foreground hover:text-[hsl(var(--feature-confessions))] transition-colors">
                <Heart size={14} />
                {c.reactions_count > 0 && <span className="text-[11px]">{c.reactions_count}</span>}
              </button>
            </div>
          </motion.div>
        ))}
